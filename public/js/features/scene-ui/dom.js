...
export function getSceneUiDom() {
  return {
    ...
    selectedInstructionCards: document.querySelector("[data-scene-selected-cards='instruction']"),
    selectedContextCards: document.querySelector("[data-scene-selected-cards='context']"),
    sceneCardLibraryButtons: Array.from(document.querySelectorAll("[data-scene-load-card]")),
    ...
    characterGrid: document.querySelector("[data-scene-character-grid]"),
    ...
    characterSource: document.querySelector("[data-scene-character-source]"),
    characterForm: document.querySelector("[data-scene-character-form]"),
    characterTitleInput: document.querySelector("#scene-character-title-input"),
    characterNameInput: document.querySelector("#scene-character-name-input"),
    characterGenderInputs: Array.from(document.querySelectorAll("[data-scene-character-gender]")),
    characterAgeInput: document.querySelector("#scene-character-age-input"),
    characterTagEditors: Array.from(document.querySelectorAll("[data-scene-tag-editor]")),
    characterTagEditorInputs: Array.from(document.querySelectorAll("[data-scene-tag-editor-input]")),
    characterTagEditorChips: Array.from(document.querySelectorAll("[data-scene-tag-editor-chips]")),
    characterTagEditorSuggestions: Array.from(
      document.querySelectorAll("[data-scene-tag-editor-suggestions]"),
    ),
    characterCardInput: document.querySelector("#scene-character-card-input"),
    characterError: document.querySelector("[data-scene-character-error]"),
    characterSaveLibraryButton: document.querySelector("[data-scene-character-save-library]"),
    characterOpenLibraryButton: document.querySelector("[data-scene-character-open-library]"),
    characterCancelButton: document.querySelector("[data-scene-character-cancel]"),
    characterLibraryDialog: document.querySelector("[data-scene-character-library-dialog]"),
    characterLibraryTarget: document.querySelector("[data-scene-character-library-target]"),
    characterLibrarySearch: document.querySelector("[data-scene-character-library-search]"),
    characterLibraryTags: document.querySelector("[data-scene-character-library-tags]"),
    characterLibraryError: document.querySelector("[data-scene-character-library-error]"),
    characterLibraryList: document.querySelector("[data-scene-character-library-list]"),
    characterLibraryCloseButton: document.querySelector("[data-scene-character-library-close]"),
    sceneCardLibraryDialog: document.querySelector("[data-scene-card-library-dialog]"),
    sceneCardLibraryTitle: document.querySelector("[data-scene-card-library-title]"),
    sceneCardLibrarySearch: document.querySelector("[data-scene-card-library-search]"),
    sceneCardLibraryError: document.querySelector("[data-scene-card-library-error]"),
    sceneCardLibraryList: document.querySelector("[data-scene-card-library-list]"),
    sceneCardLibraryCloseButton: document.querySelector("[data-scene-card-library-close]"),
    sceneCardForm: document.querySelector("[data-scene-card-form]"),
    sceneCardFormTitle: document.querySelector("[data-scene-card-form-title]"),
    sceneCardTitleInput: document.querySelector("#scene-card-title-input"),
    sceneCardDescriptionInput: document.querySelector("#scene-card-description-input"),
    sceneCardTextInput: document.querySelector("#scene-card-text-input"),
    sceneCardSaveButton: document.querySelector("[data-scene-card-save]"),
    sceneCardNewButton: document.querySelector("[data-scene-card-new]"),
